...
GLUI_BitmapBox   *GLUI:: add_bitmapbox( 
	const char *name,
	int id, 
	GLUI_Update_CB callback,
   bool active)
{
  return add_bitmapbox_to_panel( main_panel,	name, id, callback, active );
}


/*********************************** GLUI:: add_bitmapbox_to_panel() **********/
GLUI_BitmapBox  *GLUI::add_bitmapbox_to_panel( 
	GLUI_Panel *panel,
	const char *name,
	int id, 
	GLUI_Update_CB callback,
   bool active)
{
	GLUI_BitmapBox *control;

	control = new GLUI_BitmapBox;
...
GLUI_Graph   *GLUI:: add_graph( 
	const char *name,
	int id, 
	GLUI_Update_CB callback )
{
  return add_graph_to_panel( main_panel,	name, id, callback );
}


/*********************************** GLUI:: add_graph_to_panel() **********/
GLUI_Graph  *GLUI::add_graph_to_panel( 
	GLUI_Panel *panel,
	const char *name,
	int id, 
	GLUI_Update_CB callback )
...
GLUI_ActiveText   *GLUI:: add_activetext( const char *name,
				  int id, GLUI_Update_CB callback )
{
  return add_activetext_to_panel( main_panel,
			      name, id, callback );
}


/*********************************** GLUI:: add_activetext_to_panel() **********/

GLUI_ActiveText   *GLUI::add_activetext_to_panel( GLUI_Panel *panel,
					  const char *name,
					  int id, 
					  GLUI_Update_CB callback )
{
  GLUI_ActiveText *control;
  
  control = new GLUI_ActiveText;
