...
/* XXX - Begin - Hack in mouse wheel */
#ifndef WM_MOUSEWHEEL
#define WM_MOUSEWHEEL 0x020A
#endif
/* XXX - End - Hack in mouse wheel */
...
/* XXX - Begin - Hack in mouse wheel */
   case WM_MOUSEWHEEL:
   {
      ...
      s        = (short) HIWORD(wparam);
    /*k        = (short) LOWORD(wparam);*/
...
/*
      while (s < 0)
      {
         __glutOnKey(hwnd, VK_DOWN,  TRUE, 0, 0);
         __glutOnKey(hwnd, VK_DOWN, FALSE, 0, 0);
         s++;
      }
      while (s > 0)
      {
         __glutOnKey(hwnd, VK_UP,  TRUE, 0, 0);
         __glutOnKey(hwnd, VK_UP, FALSE, 0, 0);
         s--;
      }
*/
      ...
      __glutOnButtonDn (hwnd, point.x, point.y,     GLUT_MIDDLE_BUTTON);
      __glutOnMouseMove(hwnd, point.x, point.y + s, MK_MBUTTON);
      __glutOnButtonUp (hwnd, point.x, point.y + s, GLUT_MIDDLE_BUTTON);
