...
//     printf(" milliseconds:  %ld\n", 1000l * (tv2.tm_sec - tv1.tm_sec) +
//            (tv2.tm_sec - tv1.tm_sec) / 1000l);
  }
#endif /* not NO_TIMER */
...
//              1000l * (tv3.tm_sec - tv2.tm_sec) +
//              (tv3.tm_sec - tv2.tm_sec) / 1000l);
    }
  }
#endif /* not NO_TIMER */
  ...
  if (!b.quiet) {
    gettimeofday(&tv4, &tz);
    if (b.poly && !b.refine) {
//       printf("Hole milliseconds:  %ld\n", 1000l * (tv4.tm_sec - tv3.tm_sec) +
//              (tv4.tm_sec - tv3.tm_sec) / 1000l);
    }
  }
#endif /* not NO_TIMER */
...
//              1000l * (tv5.tm_sec - tv4.tm_sec) +
//              (tv5.tm_sec - tv4.tm_sec) / 1000l);
    }
#endif /* not CDT_ONLY */
  }
#endif /* not NO_TIMER */
...
//            1000l * (tv6.tm_sec - tv5.tm_sec) +
//            (tv6.tm_sec - tv5.tm_sec) / 1000l);
//     printf("Total running milliseconds:  %ld\n",
//            1000l * (tv6.tm_sec - tv0.tm_sec) +
//            (tv6.tm_sec - tv0.tm_sec) / 1000l);
#endif /* not NO_TIMER */
