...
//val,lod = [0:1]
float
get_lod_f(in float val, in float lod)
{
  float p = lod / 2.0;
  float h;
...
main()
{
  ...
  gl_FragColor = vec4(mix(my_style.ink, gl_Color.rgb, t), 1.0);
}
