...
vec2
get_noise(in vec2 uv, in float noise_scale)
{
...
main()
{
  ...
  vec2 noise_hi =
    get_noise(uv_lo, style_info.noise_scale) * style_info.noise_amp;
  vec2 noise_lo =
    get_noise(uv_hi, style_info.noise_scale) * style_info.noise_amp * 0.5;
