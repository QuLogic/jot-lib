...
JOTappConfig::tags() const
{
   if (!_ja_tags) {
      ...
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_ACTION");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_APPLY_SKEL");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_BASECOAT_SHADER");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_BBASE_RES_LEVEL");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_BBASE_SUBDIV_GEN");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_BBASE_UPDATE");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_BBASE_XFORM");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_BCURVE_BOUNDARY");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_BCURVE_CONSTRUCTOR");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_BCURVE_DELETE_ELS");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_BCURVE_EMBEDDED");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_BCURVE_MAP_CONSTRUCTOR");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_BCURVE_ON_SKIN");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_BCURVE_ON_VERTS");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_BCURVE_RESAMPLE");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_BFACE_LIST_IS_CONNECTED");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_BFACE_LIST_SUBDIVISION");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_BINARY_IMAGE");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_BLUR_SHADER");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_BNODE");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_BNODE_DESTRUCTOR");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_BNODE_INVALIDATE");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_BNODE_TICK");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_BNODE_TOPO_SORT");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_BNODE_UPDATE");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_BNODE_XFORM");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_BPOINT_FRAME");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_BPOINT_MEME");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_BPOINT_MOVE");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_BUILD_CURVE");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_BUILD_REVOLVE");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_BUILD_TUBE");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_CAM_FOCUS");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_CAM_FSA");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_CELL");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_CHECK_PLANE");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_CIRCLE");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_CIRCLE_WIDGET_ALL");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_CIRCLE_WIDGET_GO");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_CIRCLE_WIDGET_INIT");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_CLEAN_ON_EXIT");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_CONNECTED_LIST");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_CREASE_WIDGET");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_CREATE_CURVE");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_CREATE_RECT");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_CREATE_RIBBONS");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_CRV_BOUNDARIES");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_CRV_SKETCH_INIT");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_CRV_SKETCH_OVERSKETCH");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_CRV_SKETCH_STROKE_CB");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_CRV_SKETCH_UPDATE");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_CS_DRAW_SPANS");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_CURSOR3D");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_CURVE_BINORMS");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_CURVE_NORMS");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_CURVE_PTS");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_D2D_SAMPLES");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_DATA_ITEM");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_DEBUG_UV");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_DISK_MAP");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_DISTRIB");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_DOTS");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_DRAW_MANIP");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_DT");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_EDGE_SWAP");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_EDIT_LEVEL_CHANGED");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_ELLIPSE");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_EXTENDER_CIRCLE_CB");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_EXTENDER_STROKE_CB");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_EXTENDER_SWEEP_BALL");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_FIX_ORIENTATION");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_FLOOR_REALIGN");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_FPS");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_GEST_INT");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_GET_DRAW_PLANE");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_GET_PRIMITIVE");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_GET_SUBDIV_CHAIN");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_GLSL_HALO");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_GLSL_HATCHING");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_GLSL_MARBLE");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_GLSL_NORMAL");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_GLSL_PAPER");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_GLSL_SHADER");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_GLSL_TOON");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_GLSL_XTOON");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_GLUT_WACOM");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_GLUT_WINSSYS");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_GRID");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_HALFTONE");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_HALO_SPHERE");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_HALO_UPDATE");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_HATCHING");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_HISTOGRAM");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_ICON2D");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_IMAGE_LINE_SHADER");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_INC_SEC_DISK");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_INC_SEC_QUAD");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_INC_SEC_TRI");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_INSET_QUAD");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_IO");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_JOT_CMD");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_JOT_GLUT_IDLE_CB");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_LAYER_BASE");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_LINE_CB");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_LMESH_FIT");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_LMESH_SUBDIV_INPUTS");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_MAP2D3D");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_MATCH_SPANS");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_MEME_DEMOTION");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_MEME_DESTRUCTOR");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_MEMES");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_MEME_SUBDIV_GEN");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_MESH_MERGE");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_MESH_OPS");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_MIN_DISTORT");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_MOVE_CMD");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_MSLD");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_MULTI_LIGHTS_TONE");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_NAME_LOOKUP");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_NET_STREAM");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_NON_MANIFOLD");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_OBJ2SM");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_OBJ_READER");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_OVERSKETCH");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_P2H");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_PAINTERLY");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_PANEL_CELLS");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_PANEL_OP");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_PAPER_DOLL");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_PATCH_BLEND_WEIGHTS");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_PATCH_FOCUS");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_PATCH_PEN");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_PATCH_READ_STREAM");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_PICK_FACE");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_PLY2SM");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_PNG2SM");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_PRIMITIVE");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_PRIMITIVE_CREATE_BALL");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_PRIMITIVE_FIND_SKEL_CURVE");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_PRIMITIVE_INIT");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_PROFILE");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_PROXY_SURFACE");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_PROXY_TEXTURE");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_PUNCH");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_PUSH_FACES");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_QUAD_PANEL");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_REF_IMAGES");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_RE_TESS");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_RIDGE");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_ROOF");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_ROOF_STROKE_CB");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_SCHEDULER");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_SELECT_SKEL_CURVE");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_SIMPLE_TUBE");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_SKIN");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_SKIN_CURVE_MAP_CONSTRUCTOR");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_SKIN_CURVE_SETUV");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_SKIN_MEMES");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_SKIN_UPDATE");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_SKYBOX");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_SLASH");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_SLASH_TAP");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_SMALL_CIRCLE");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_SPECIFY_UPPER");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_SPLIT_TRI");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_SPS");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_SSUBRAMA");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_STROKE_CB");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_STRPOOL");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_SUBDIV_UPDATER");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_SURF_CURVE_MAP_CONSTRUCTOR");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_SURF_CURVE_MAP_RECOMPUTE");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_SURF_CURVE_SETUV");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_SWEEP_BASE_EXTEND");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_SWEEP_HIT_BOUNDARY");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_SWEEP_LINE_CB");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_SWEEP_SETUP");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_SWEEP_TRIM");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_TAP");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_TEX_USE_MIPMAP");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_TEXBODY_XFORM");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_TEXTURE");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_TONE_SHADER");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_TRI_PANEL");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_UV_DATA");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_UV_INTERSECT");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_UV_SURF_SMOOTH_UVS");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_VERT_MAPPER");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_VIS_REF");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_VOLUME_PRESERVATION");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_WEAK_EDGES");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_WIREFRAME");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_XFORM_CMD");
      *_ja_tags += new BOOL_VARIABLE(JOTappConfig, "DEBUG_XFORM_PEN");
   }
   return *_ja_tags;
}
