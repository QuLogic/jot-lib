 ...
 *****************************************************************/
#ifndef _HATCHING_UI_H_IS_INCLUDED_
#define _HATCHING_UI_H_IS_INCLUDED_
 ...
 * HatchingUI
 *****************************************************************/
class HatchingUI : public BaseUI {
 ...
 public:
   ...
   static std::vector<HatchingUI*>  _ui;       
  
 public:
    //******** RUN-TIME TYPE ID ********
   DEFINE_RTTI_METHODS3("HatchingUI", HatchingUI*, HatchingUI, BaseUI*);

    /******** CONSTRUCTOR/DECONSTRUCTOR ********/
   HatchingUI(BaseUI* parent=nullptr);
   virtual ~HatchingUI(){}
   ...
   ToneShader*  get_tone_shader() { return (_current_hatching) ? _current_hatching->get_tone_shader() : nullptr; }
   bool         load_preset();
   bool         save_preset();
 protected:   
   /******** MEMBERS VARS ********/
 ...
 protected:     
   ...
   void         apply_changes();
   void         apply_changes_to_texture(operation_id_t op, HatchingTX* tex, int layer);
